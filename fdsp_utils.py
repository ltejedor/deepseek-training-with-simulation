...
#     parser.add_argument('--chk-path', type=str, required=True, help="Path for saving checkpoints")
#     parser.add_argument('--dataset-id', type=str, required=True, help="Dataset ID for loading data")
#     # Add these two arguments to match your command line options:
#     parser.add_argument('--num-epochs', type=int, default=10, help="Number of training epochs")
#     parser.add_argument('--save-interval', type=int, default=10, help="Interval (in epochs) at which to save checkpoints")
#     return parser
